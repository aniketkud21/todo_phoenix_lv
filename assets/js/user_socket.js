...
// And connect to the path in "lib/collab_doc_web/endpoint.ex". We pass the
...
//
// In your "lib/collab_doc_web/router.ex":
//
//     pipeline :browser do
//       ...
//       plug MyAuth
...
// inside a script tag in "lib/collab_doc_web/templates/layout/app.html.heex":
//
//     <script>window.userToken = "<%= assigns[:user_token] %>";</script>
//
// You will need to verify the user token in the "connect/3" function
// in "lib/collab_doc_web/channels/user_socket.ex":
//
...
// let channel = socket.channel("room:33", {})
// channel.join()
...
// Find the index of 'todos' in the path
var todosIndex = pathArray.indexOf('todos');

// Extract the todo ID from the path
var todoId = pathArray[todosIndex + 1];
